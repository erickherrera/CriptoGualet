...
void QtSuccessDialog::setupUI() {
    ...
    int baseFontSize =
        std::max(12, std::min(14, static_cast<int>(m_screenGeometry.height() * 0.016)));
    int titleFontSize =
        std::max(16, std::min(20, static_cast<int>(m_screenGeometry.height() * 0.021)));
    ...
    m_messageLabel =
        new QLabel(QString("Account created for %1<br>Your seed phrase has been securely backed up")
                       .arg(m_username),
                   m_card);
    ...
    int buttonWidth =
        std::max(100, std::min(120, static_cast<int>(m_screenGeometry.width() * 0.06)));
    int buttonHeight =
        std::max(32, std::min(40, static_cast<int>(m_screenGeometry.height() * 0.045)));
...
void QtSuccessDialog::applyTheme() {
    ...
    if (m_card) {
        m_card->setStyleSheet(QString("QFrame#successCard {"
                                      "   background-color: %1;"
                                      "   border-radius: 24px;"
                                      "   border: none;"
                                      "}")
    ...
    if (m_successIcon) {
        m_successIcon->setStyleSheet(QString("QLabel#successIcon {"
                                             "   color: %1;"
    ...
    if (m_titleLabel) {
        m_titleLabel->setStyleSheet(QString("QLabel#successTitle {"
                                            "   font-size: 18px;"
                                            "   font-weight: 700;"
                                            "   color: %1;"
                                            "   background-color: transparent;"
    ...
    if (m_messageLabel) {
        m_messageLabel->setStyleSheet(QString("QLabel#successMessage {"
                                              "   font-size: 14px;"
                                              "   color: %1;"
                                              "   background-color: transparent;"
                                              "   padding: 4px 0px;"
    ...
    if (m_infoLabel) {
        m_infoLabel->setStyleSheet(QString("QLabel#successInfo {"
                                           "   font-size: 13px;"
                                           "   color: %1;"
                                           "   background-color: transparent;"
    ...
    if (m_okButton) {
        m_okButton->setStyleSheet(QString("QPushButton#successButton {"
                                          "   background-color: %1;"
                                          "   color: white;"
                                          "   border: none;"
                                          "   border-radius: 12px;"
                                          ...
                                          "   background-color: %3;"
                                          "}")
                                      .arg(accentColor.name(), accentColor.darker(110).name(),
