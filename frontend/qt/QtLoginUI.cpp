...
void QtLoginUI::setupUI() {
    ...
    m_mainLayout->setContentsMargins(
        m_themeManager->standardMargin(), m_themeManager->generousMargin(),
        m_themeManager->standardMargin(), m_themeManager->generousMargin());
...
void QtLoginUI::createLoginCard() {
    ...
    auto positionLoginToggle = [this]() {
        ...
        const int y = (m_loginPasswordEdit->height() - m_loginPasswordToggleButton->height()) / 2;
        m_loginPasswordToggleButton->move(x, y);
    };

    connect(m_loginPasswordEdit, &QLineEdit::textChanged, this, positionLoginToggle);
    ...
    connect(m_passwordEdit, &QLineEdit::textChanged, this, positionRegisterToggle);
    ...
    connect(m_loginUsernameEdit, &QLineEdit::returnPressed, this, &QtLoginUI::onLoginClicked);
    connect(m_loginPasswordEdit, &QLineEdit::returnPressed, this, &QtLoginUI::onLoginClicked);
    ...
    connect(m_restoreSeedButton, &QPushButton::clicked, this, &QtLoginUI::onRestoreSeedClicked);
}
...
void QtLoginUI::onRevealSeedClicked() {
    ...
    QObject::connect(box, &QDialogButtonBox::accepted, &authDlg, &QDialog::accept);
    QObject::connect(box, &QDialogButtonBox::rejected, &authDlg, &QDialog::reject);
    ...
    QLabel* warn = new QLabel(
        "<b>Anyone with this can access your wallet.</b><br/>"
    ...
    QPushButton* copySeed = new QPushButton("Copy Seed (auto-clears in 30s)", &reveal);
    ...
    QDialogButtonBox* box2 = new QDialogButtonBox(QDialogButtonBox::Close, Qt::Horizontal, &reveal);
...
void QtLoginUI::onRestoreSeedClicked() {
    ...
    QLabel* info = new QLabel(
        "Paste your 12 or 24 BIP-39 words (single line or "
...
void QtLoginUI::updateStyles() {
    ...
    QString buttonStyle = QString(R"(
        ...
        QPushButton:disabled {
            ...
            color: %5;
                              ...
                              .arg(accentHex, m_themeManager->accentColor().lighter(110).name(),
    ...
    QTimer::singleShot(0, this, [this]() {
        ...
        if (m_loginPasswordEdit && m_loginPasswordToggleButton) {
            ...
            const int x = m_loginPasswordEdit->width() - buttonWidth - padding;
            const int y =
                (m_loginPasswordEdit->height() - m_loginPasswordToggleButton->height()) / 2;
            m_loginPasswordToggleButton->move(x, y);
        }
...
void QtLoginUI::showMessage(const QString& message, bool isError) {
    if (m_messageLabel) {
        ...
        m_messageLabel->setStyleSheet(isError ? m_themeManager->getErrorMessageStyleSheet()
