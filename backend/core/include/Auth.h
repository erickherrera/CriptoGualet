...
// Shutdown and reset database connection
// Useful for testing to allow reinitialization with different database paths
...
TwoFactorSetupData InitiateTwoFactorSetup(const std::string& username, const std::string& password);
